    ...
    const steps = [
        {
            ...
            right: {
                ...
                content: (<div>
                    ...
                    {
                        icon: <AiFillDollarCircle />,
                        text: (<div>The <strong>Athlete Information Management System (AIMs) fee</strong> funds the university's Club Sports program. You only pay this once per semester to join all club sports.</div>),
                        isAvailable: true,
                    },
                    {
                        icon: <AiFillDollarCircle />,
